...
KERNEL_FQ void m16900_comp (KERN_ATTR_TMPS_ESALT (pbkdf2_sha256_tmp_t, ansible_vault_t))
{
  ...
  sha256_hmac_init (&ctx, key, 32);

  sha256_hmac_update_global_swap (&ctx, esalt_bufs[DIGESTS_OFFSET_HOST].ct_data_buf, esalt_bufs[DIGESTS_OFFSET_HOST].ct_data_len);
